...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        $this->user_playlist = new ArrayCollection();
    }
    ...
    public function addUserPlaylist(Playlist $userPlaylist): self
    {
        if (!$this->user_playlist->contains($userPlaylist)) {
    ...
    public function removeUserPlaylist(Playlist $userPlaylist): self
    {
        if ($this->user_playlist->removeElement($userPlaylist)) {
